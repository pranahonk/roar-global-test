        ...
        {(menuItem) => (
          <li>
            <a
              ...
              class="flex flex-row items-center gap-3 p-3 transition-colors rounded text-white hover:text-black focus:text-black hover:bg-white focus:bg-white aria-[current=page]:text-white aria-[current=page]:bg-black"
            >
...
const Sidebar = () => {
  const [ , setExpandedMenus] = createSignal<
    Record<string, boolean>
  >({});
  ...
  return (
    <aside
      ...
      class="fixed top-0 bottom-0 left-0 z-50 flex flex-col transition-transform bg-[#7bafe2] -translate-x-full border-r w-72 sm:translate-x-0 border-r-slate-200"
    >
      <nav
        aria-label="side navigation"
