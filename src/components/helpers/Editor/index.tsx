...
<p>2024-02-26</p>
    <p>
        Gastropub chillwave lumbersexual umami lyft. Poke austin direct trade, marfa raclette letterpress actually.
        Chartreuse sriracha pinterest twee lo-fi try-hard. Meditation
    </p>
    <p>
        banh mi kitsch, prism organic hot chicken literally heirloom occupy af semiotics food truck.
    </p>
    <p>
        Aesthetic asymmetrical gluten-free, health goth shaman meh lumbersexual bespoke kinfolk helvetica vaporware fashion axe freegan. Pour-over hammock succulents
        disrupt chartreuse raw denim. Brunch aesthetic fanny pack subway tile everyday carry green juice neutra beard cray small batch poke yuccie plaid pork belly. Blue
        bottle 8-bit flexitarian hashtag. Scenester marfa yuccie snackwave edison bulb. VHS blog pickled scenester venmo hashtag lo-fi,
    </p>
`;
...
export default function ToolbarEditor(): JSX.Element {
    ...
    return (
        <div class="w-full rounded-xl h-screen bg-gray-200 flex items-center justify-center">
